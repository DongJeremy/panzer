...
import org.cloud.panzer.mapper.TokenMapper;
...
public class TokenServiceDbImpl implements TokenService {
    ...
    private LoginUser toLoginUser(TokenModel model) {
        ...
        System.out.println(model.getExpireTime());
        // 校验是否已过期
    ...
    public Set<String> getAllTokenList(String pattern) {
        ...
        return tokenModels.stream().map(this::getJWTFromUUID).collect(Collectors.toSet());
    }
